  ...
  return (
    <div>
      <p className="left" style={{ padding: "3vh 4vh" }}>
        <span className="bold">WHY, HELLO THERE! :)</span>
        <br></br>
        <br></br>
        ...
        taught me the importance of consistency and rewarded me with the
        ...
        ... and a trend for creative problem-solving was born!
        <br></br>
        <br></br>
        ...
        . I am thus undeniably and irrevocably a 100% certifiable (and
        certified!) nerd, geek, and dork.
        <br></br>
        <br></br>
        ...
        <br></br>
        <br></br>
        Much could be written about the next ten years of my life. Yet as surely
        only my mother is reading at this point, I will only say how blessed I
        am to have been gifted this decade of service, "non-profit" work.
        <br></br>
        <br></br>
        ...
        <br></br>
        <br></br>
        <span className="bold">TO NEW ADVENTURES!</span>
        <br></br>
        <br></br>
        ...
        happy last — a software developer, ready to bring greater beauty and
        order to the world through code.
        <br></br>
        <br></br>
        In my spare time, I enjoy hiking with friends, watching others play
        Minecraft, and <span className="italics">not</span> taking long walks on
        the beach, lest the sand get in in-every-which-spot.
        <br></br>
        <br></br>
        ...
        <br></br>
        <br></br>
        <span className="bold">ENJOY YOUR STAY :D</span>
      </p>
    </div>
  );
};
